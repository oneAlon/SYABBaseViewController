...
public class SYABNetworkManager: NSObject {
    
    static public let shared: SYABNetworkManager = {
        let instance: SYABNetworkManager = SYABNetworkManager()
        return instance
    }()
